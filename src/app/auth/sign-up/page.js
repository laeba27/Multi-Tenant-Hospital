...
export default function SignUpPage() {
  ...
  const onHospitalSubmit = async (hospitalData) => {
    ...
    try {
      ...
      toast.success('Registration submitted. Please wait for super admin approval before signing in.')
      setTimeout(() => {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-indigo-50 via-white to-blue-50 flex items-center justify-center px-4 py-8 sm:py-12">
      <div className="w-full max-w-lg">
        {/* Card Container */}
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          {/* Header Section */}
          <div className="bg-linear-to-r from-indigo-600 to-indigo-700 px-6 sm:px-8 py-8 sm:py-10 text-white">
        ...
        <p className="text-center text-gray-500 text-xs mt-6">
          Your information is secure and encrypted. Login access is enabled after super admin approval.
        </p>
      </div>
    </div>
  )
